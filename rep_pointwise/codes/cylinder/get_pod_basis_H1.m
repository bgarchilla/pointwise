...
u0=mean(U(:,1:end),2); v0=mean(V(:,1:end),2); N=size(U,2)-1;
% U=U(:,2:end); V=V(:,2:end); N=size(U,2);
w0=[u0;v0];

Ic=nTc;
[Sn,Mn,Dxn,Dyn,Mp,Sp,GD11n,GD12n,GD22n]=makronvq_skw(T,z,1,Ic,phi,ccphi);
...
increPOD=incre;
save ../../data/output_data/cylinder/pod_basis_H1 I Sn w0 Phi ss increPOD
